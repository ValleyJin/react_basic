...
import com.beanlog.lesson15.web.dto.MenuRequest;
import com.beanlog.lesson15.web.dto.MenuResponse;
...
/**
 * 메뉴 REST API — GET 은 공개, POST/PUT/DELETE 는 ROLE_ADMIN 만 (PreAuthorize).
 */
@RestController
